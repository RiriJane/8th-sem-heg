<!-- TOC START min:1 max:99 link:true asterisk:false update:true -->
- [TABLE DES MATIERES](#table-des-matieres)
- [REVISION PROGRAMMATION ORIENTEE OBJETS](#revision-programmation-orientee-objets)
  - [Encapsulation](#encapsulation)
  - [Visibilité de l'information](#visibilité-de-linformation)
  - [Abstraction](#abstraction)
  - [Encapsulation vs Abstraction vs Visbilité](#encapsulation-vs-abstraction-vs-visbilité)
  - [HERITAGE](#heritage)
  ...
  - [READER](#reader)
      ...
      - [CHARACTER BY CHARACTER - VERSION 2](#character-by-character---version-2)
      - [BY LINE](#by-line)
  - [EXCEPTIONS](#exceptions)
      - [DEFINIR SA PROPRE EXCEPTION](#definir-sa-propre-exception)
  - [HIERARCHIE CLASSES JAVA](#hierarchie-classes-java)
  - [COMPARABLE](#comparable)
  - [COMPARATOR](#comparator)
- [TYPES ABSTRAITS DE DONNEES](#types-abstraits-de-donnees)
      - [FORMALISME - 3 ELEMENTS](#formalisme---3-elements)
      - [POURQUOI UTILISER DES FORMALISME](#pourquoi-utiliser-des-formalisme)
- [CLASSES/TYPES GENERIQUES](#classestypes-generiques)
      - [EXEMPLE AVEC LES ARRAYLISTS](#exemple-avec-les-arraylists)
      - [EXEMPLE EN CREANT NOTRE PROPRE CLASSE DE TYPES GENERIQUES](#exemple-en-creant-notre-propre-classe-de-types-generiques)
- [ENUMERATIONS](#enumerations)
      - [DECLARATION](#declaration)
      - [EXEMPLE DE CODE](#exemple-de-code)
      - [CREATION D'UNE CLASSE ENUM](#creation-dune-classe-enum)
- [EXTENSION DE FONCTIONNALITE](#extension-de-fonctionnalite)
  - [CLASSE ENVELOPPE - WRAPPER](#classe-enveloppe---wrapper)
  - [INTERFACE](#interface)
- [CHECKLIST](#checklist)
<!-- TOC END -->
